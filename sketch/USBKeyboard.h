...
class USBKeyboard {
 public:
  ...
  void sendKeyStroke(byte keyStroke, byte modifiers) {
    ...
    Serial.write((byte)0);          // Reserved
    Serial.write(keyStroke);     // Keycode 1
    Serial.write((byte)0);          // Keycode 2  
    Serial.write((byte)0);          // Keycode 3
    Serial.write((byte)0);          // Keycode 4
    Serial.write((byte)0);          // Keycode 5
    Serial.write((byte)0);          // Keycode 6  
